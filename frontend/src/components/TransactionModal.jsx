  ...
  return (
    <div className = "modal-overlay">
      <div className = "modal-content">
        {transaction ? (<h1 className = "absolute top-4 left-4 text-gray-800 font-semibold text-xl">Edit Transaction</h1>) : (<h1 className = "absolute top-4 left-4 text-gray-800 font-semibold text-xl">Create New Transaction</h1>)}
        <button className = "absolute top-4 right-4 text-gray-800 font-semibold" onClick = {onClose}>Close</button>

        <div className = "flex gap-4">
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Select Account</h2>
          ...
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Select Category</h2>
        ...
        <div className = "flex gap-4">  
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Enter Amount</h2>
            <input className = "modal-input" placeholder = "Enter Amount" value = {amount} onChange = {(e) => setAmount(e.target.value)}></input>
          </div>
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Select Type</h2>
        ...
        <div className = "flex gap-4">   
          ...
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Date of Transaction</h2>
            <input className = "modal-input" type = "date" value = {date} onChange = {(e) => setDate(e.target.value)}></input> 
          </div>
        </div>

        {transaction ? ( <button className = "text-gray-800 font-semibold" onClick = {handleSubmit}>Save</button>) : ( <button className = "text-gray-800 font-semibold" onClick = {handleSubmit}>Create</button>)}
