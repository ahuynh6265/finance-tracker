  ...
  return (
    <div className = "modal-overlay">
      <div className = "modal-content">
        <h1 className = "absolute top-4 left-4 text-gray-800 text-xl font-semibold">Transfer Money</h1>
        <button className = "absolute top-4 right-4 text-gray-800 font-semibold" onClick = {onClose}>Close</button>

        <div className = "flex gap-4">
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Transfer From</h2>
          ...
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Transfer To</h2>
        ...
        <div className = "flex gap-4">
          ...
          <div className = "w-full">
            <h2 className = "text-gray-800 font-semibold">Date of Transfer</h2>
            <input className = "modal-input" type = "date" value = {date} onChange = {(e) => setDate(e.target.value)}></input> 
          </div>
        </div>

        <button className = "text-gray-800 font-semibold" onClick = {handleSubmit}>Send Money</button>
